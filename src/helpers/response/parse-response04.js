...
const getUsersResponseData = async function (responseData, token = null) {
	const responseUserData = {
		...
		first_name: (responseData.first_name) ? responseData.first_name : '',
...
const getInvoiceResponseData = async function (responseData, inv_id = null) {
	...
	const responseInvoiceData = {
		...
		purchase_order: (responseData.purchase_order) ? responseData.purchase_order : '',
		...
		total_price: (responseData.inv_id) ? await queryHelper.getSumofSellingPriceByInvoiceId(responseData.inv_id) : '',
...
const getAllInvoiceResponseData = async function (responseData, inv_id = null) {
	const responseAllInvoiceData = {
		...
		due_date: (responseData.due_date) ? responseData.due_date : '',
		amount: responseData.inv_id ? await queryHelper.getSumofSellingPriceByInvoiceId(responseData.inv_id) : '',
	};
