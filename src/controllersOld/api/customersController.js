                ...
                await Customers.create(customer).then(async customerSaveDetails => {
                    const address =[
                        billing_address={
                            ...
                            zip_code:req.body.billing_address.zip_code?req.body.billing_address.zip_code:"",
                        ...
                        shipping_address={
                            ...
                            type:req.body.shipping_address.type,
                        }
                    ]
...
exports.getAllCustomers = async (req, res) => {
    ...
    {  
        ...
        else
        {
            ...
            Customers.findAndCountAll({offset: pagingOffset, limit: pagingLimit, order: [['id', 'DESC']]}).then(async customerList => {
...
exports.getAllCustomersContact = async (req, res) => {
    try
    {
        ...
        success(res,200,'Customer Details',customer)
    }
    catch(err)
    {
        customResponse(res, 1, err);
